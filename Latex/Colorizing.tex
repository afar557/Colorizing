...
\textbf{\Large The Basic Coloring Agent} \\
 ...
 We start off by choosing 5 random points on the graph and using k-means and the Euclidean distance based on color we get more accurate 5 color points that accurately represent the colors of our data, as much as 5 colors possibly could. \\\\
